...
static const pcg128_t PCG_STATE_SETSEQ_128_INITIALIZER_STATE = (pcg128_t){0x979c9a98d8462005ULL, 0x7d3e9cb6cfe0549bULL};
static const pcg128_t PCG_STATE_SETSEQ_128_INITIALIZER_INCREMENT = (pcg128_t){0x0000000000000001ULL, 0xda3e39cb94b95bdbULL};
