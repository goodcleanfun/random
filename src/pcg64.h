...
#define PCG_DEFAULT_MULTIPLIER_128 \
        (pcg128_t) PCG_128BIT_CONSTANT(2549297995355413924ULL,4865540595714422341ULL)
#define PCG_DEFAULT_INCREMENT_128  \
        (pcg128_t) PCG_128BIT_CONSTANT(6364136223846793005ULL,1442695040888963407ULL)

#define PCG_STATE_SETSEQ_128_INITIALIZER                                       \
    { (pcg128_t) PCG_128BIT_CONSTANT(0x979c9a98d8462005ULL, 0x7d3e9cb6cfe0549bULL),       \
      (pcg128_t) PCG_128BIT_CONSTANT(0x0000000000000001ULL, 0xda3e39cb94b95bdbULL) }
